 ...
 *
 * This file was generated by dtcodegen, from project ui
 *
...
main(int argc, char **argv)
{
    ...
    toplevel = XtAppInitialize(&app, "Ui",
     ...
     */
    dtbMainWinMainwindowInfo_clear(&dtb_main_win_mainwindow);
    dtbMainWinDialogAboutInfo_clear(&dtb_main_win_dialog_about);
    dtbMainWinDialogBookmarksInfo_clear(&dtb_main_win_dialog_bookmarks);
    dtbMainWinDialogSecurityInfo_clear(&dtb_main_win_dialog_security);
    dtbMainWinFileSelnInfo_clear(&dtb_main_win_file_seln);
    dtbMainWinFileSelnSaveasInfo_clear(&dtb_main_win_file_seln_saveas);
    
    /*
     * Set up the application's root window.
     */
    dtb_main_win_mainwindow.mainwindow = toplevel;

    XtVaSetValues(dtb_main_win_mainwindow.mainwindow,
        XmNallowShellResize, True,
        XmNtitle, "Websurf:",
        XmNiconName, "Websurf",
        XmNinitialState, NormalState,
        XmNbackground, dtb_cvt_string_to_pixel(dtb_main_win_mainwindow.mainwindow, "white"),
        NULL);
    
    dtb_main_win_mainwindow_initialize(&(dtb_main_win_mainwindow), dtb_get_toplevel_widget());
